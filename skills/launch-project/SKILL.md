---
name: launch-project
description: Co-creation launch and distribution workflow for agentic builders and anyone shipping products with AI — indie SaaS, apps, AI products, AI agents, developer tools, MCP servers, open-source projects, SDKs, CLIs, APIs, and plugins. Use when a user wants to take a shippable project to launch, prepare Product Hunt or Show HN submissions, find launch channels with little existing audience, co-write channel-native launch copy in the builder's own voice, choose the right platforms and optimal posting times, build an outreach plan and launch schedule, or turn post-launch feedback into follow-up distribution.
---
...
- Reply bank as shapes the builder answers in their own words.
