...
Read `references/copy-templates.md` when drafting channel copy, outreach, replies, or recap text.
...
Produce only the outputs that fit the user's request:
...
- Launch-day schedule.
- Reply bank for likely questions and objections.
